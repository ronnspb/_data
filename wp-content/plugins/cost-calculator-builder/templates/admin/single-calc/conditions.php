...
<div class="ccb-create-calc ccb-condition-container calc-quick-tour-conditions">
	...
	<template v-else>
		...
		<div class="flowchart-container is-pro-part" v-if="$store.getters.getQuickTourStep === 'done' || $store.getters.getQuickTourStep === '.calc-quick-tour-title-box'">
			<div class="ccb-condition-is-pro-container">
				<div class="ccb-condition-is-pro-container__header">
					<div class="ccb-condition-is-pro-container__image-box">
						...
						<span><?php esc_html_e( 'This feature is part of Pro version', 'cost-calculator-builder' ); ?></span>
					</div>
					<div>
						<a href="https://stylemixthemes.com/cost-calculator-plugin/pricing/?utm_source=calcwpadmin&utm_medium=freetoprobutton&utm_campaign=conditions" target="_blank" class="ccb-button ccb-href success"><?php esc_html_e( 'Upgrade Now', 'cost-calculator-builder' ); ?></a>
					</div>
				</div>
				<div class="ccb-condition-is-pro-container__content">
					<img src="<?php echo esc_attr( esc_url( CALC_URL . '/frontend/dist/img/condition-nopro.png' ) ); ?>" alt="nopro svg">
				</div>
			</div>
		</div>
		<?php else : ?>
