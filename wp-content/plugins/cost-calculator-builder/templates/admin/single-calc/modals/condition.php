			...
			<div class="condition-list" v-for="( additionalCondition, additionalConditionIndex ) in model.conditions">
				<div class="condition">
					<div class="select-with-label">
						...
						<select @change="checkCorrectForAdditionalAnd(index)" v-model="additionalCondition.condition" style="padding-right: 0;">
					...
					<div class="select-with-label" v-if="additionalCondition.condition !== 'in' && additionalCondition.condition !== 'not in'">
						<div class="select-label">
