<div class="existing-header">
	...
	<div class="list-row calc-actions">
		<div class="list-content ccb-flex">
			...
			<a class="white" style="margin-left: 20px" v-if="$store.getters.getExisting.length" href="<?php echo esc_url( get_site_url() ) . '/wp-admin/admin-ajax.php?action=cost-calculator-custom_export_run&ccb_nonce=' . esc_attr( wp_create_nonce( 'ccb_export_nonce' ) ); ?>">
