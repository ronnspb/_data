...
$deadline      = new DateTime( '05th December 2023' );
		...
		<div class="container">
			...
			<?php if ( $is_promotion ) : ?>
				<div class="stm-discount">
					<a href="https://stylemixthemes.com/cost-calculator-plugin/pricing/?utm_source=wpadmin&utm_medium=cost-calculator&utm_campaign=black-friday-deal-page" target="_blank"></a>
					<div class="stm-discount__title">
						<span class="stm-discount__title-solid"><?php echo esc_html__( 'Win a FREE iPhone 15 Pro!', 'cost-calculator-builder' ); ?></span>
						<span class="stm-discount__title-outline"><?php echo esc_html__( '2023 PREMIUM GIVEAWAY', 'cost-calculator-builder' ); ?></span>
					</div>
				</div>
			<?php endif; ?>
