					...
					<div class="col">
						<div class="list-header ccb-settings-in-pro">
							<div class="ccb-settings-in-pro-container">
								...
								<h6 class="ccb-heading-6" style="margin-bottom: 0;line-height: 1.7; font-size: 15px"><?php esc_html_e( 'Grand Total Sticky', 'cost-calculator-builder' ); ?></h6>
							</div>
							<span class="ccb-help-tip-block" style="margin-top: 2px;">
							...
							<a class="ccb-settings-in-pro-lock" target="_blank" href="https://stylemixthemes.com/cost-calculator-plugin/pricing/?utm_source=calcwpadmin&utm_medium=freetoprobutton&utm_campaign=total_sticky">
