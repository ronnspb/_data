			...
			<div class="container">
				<div class="row ccb-p-t-15 ccb-p-b-15" style="height: 400px; position: relative">
					<div class="ccb-pro-feature-wrapper">
						...
						<a href="https://stylemixthemes.com/cost-calculator-plugin/pricing/?utm_source=calcwpadmin&utm_medium=freetoprobutton&utm_campaign=send_form" target="_blank" class="ccb-button ccb-href success"><?php esc_html_e( 'Upgrade Now', 'cost-calculator-builder' ); ?></a>
					</div>
				</div>
			</div>
		</div>
