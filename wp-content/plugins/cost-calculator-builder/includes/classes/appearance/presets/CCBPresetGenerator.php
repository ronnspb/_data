	...
	public function get_colors( $data ): array {
		return array(
			...
			'data'  => array(
				...
				'svg_color'       => $this->type->get_toggle_field( __( 'Apply accent color to SVG icons', 'cost-calculator-builder' ), 'svg_color', $data['svg_color'], 'col-12' ),
			),
		);
	}
	...
	public function get_typography( $data ) : array {
		return array(
			...
			'data'  => array(
				...
				'summary_header_font_weight' => $this->type->get_select_field( __( 'Summary font weight', 'cost-calculator-builder' ), 'summary_header_font_weight', $data['summary_header_font_weight'], $this->store->get_font_weight_options(), 'col-6' ),
				...
				'total_text_transform'       => $this->type->get_select_field( __( 'Total field text transform', 'cost-calculator-builder' ), 'total_text_transform', $data['total_text_transform'], $this->store->get_text_transform_options(), 'col-6' ),
			...
			array(
				'desktop' => array(
					...
					'typography'            => array(
						...
						'summary_header_font_weight' => 700,
						'label_font_size'            => 12,
			...
			array(
				...
				'mobile'  => array(
					'typography'            => array(
						'header_font_size'        => 18,
						'header_font_weight'      => 'bold',
						'summary_header_size'        => 16,
						'summary_header_font_weight' => 'normal',
						'label_font_size'         => 11,
						'label_font_weight'       => 'bold',
						'description_font_size'   => 11,
						'description_font_weight' => 500,
